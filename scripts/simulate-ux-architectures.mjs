...
const PROBLEMS = [
  ...
  { id: 12, title: "Container With Most Water", tags: ["two pointers"] },
  { id: 17, title: "Longest Subarray of 1's After Deleting One Element", tags: ["sliding window"] },
  { id: 48, title: "Rotting Oranges", tags: ["bfs"] },
  { id: 56, title: "Koko Eating Bananas", tags: ["binary search"] },
...
const LEARNERS = [
  ...
  { id: "intermediate", profile: "Knows common patterns but misses edge cases and sometimes picks wrong complexity." },
